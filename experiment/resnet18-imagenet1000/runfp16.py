...
model_name = model_path_obj.stem + "_fp16.onnx"
save_path = model_path_obj.with_name(model_name)
...
top5Accuracies = []
matchesLabels = []
dir = f"/home/sylvex/onnx-mlir/experiment/resnet18-imagenet1000/output/posit8_0"
...
for i, image in enumerate(images):
    fp32Path = f"/home/sylvex/onnx-mlir/experiment/resnet18-imagenet1000/output/posit8_0/ground-truth-{i}-output_0.pb"
