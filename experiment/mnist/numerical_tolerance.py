...
def main():
    ...
    for i in range(num_iter):
        ...
        groudPath = f"/home/sylvex/onnx-mlir/experiment/mnist/output_tolerance/{posit_prefix}/ground-truth-{i}-output_0.pb"
        positPath = f"/home/sylvex/onnx-mlir/experiment/mnist/output_tolerance/{posit_prefix}/posit-{i}-output_0.pb"
    ...
    with open(f"/home/sylvex/onnx-mlir/experiment/mnist/output/{posit_prefix}/evaluation_tolerance.json", "w") as f:
