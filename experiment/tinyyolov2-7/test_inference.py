...
sess = rt.InferenceSession("/home/sylvex/onnx-mlir/experiment/tinyyolov2-7/Model/Model.onnx")
input_name = sess.get_inputs()[0].name
print('\ncomplete load onnx\n')

img = Image.open('/home/sylvex/onnx-mlir/experiment/tinyyolov2-7/people.jpg')
