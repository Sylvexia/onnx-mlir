...
def main():
    ...
    for i in range(num_iter):
        ...
        groudPath = f"/home/sylvex/onnx-mlir/experiment/resnet18-imagenet1000/output/{posit_prefix}/ground-truth-{i}-output_0.pb"
        positPath = f"/home/sylvex/onnx-mlir/experiment/resnet18-imagenet1000/output/{posit_prefix}/posit-{i}-output_0.pb"
    ...
    with open(f"/home/sylvex/onnx-mlir/experiment/resnet18-imagenet1000/output/{posit_prefix}/evaluation.json", "w") as f:
