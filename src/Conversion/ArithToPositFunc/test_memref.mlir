...
func.func @test_memrefAlloca() -> memref<8x32xf32> {
  %0 = memref.alloca() : memref<8x32xf32>
...
func.func @test_memrefdim(%arg0: memref<1x64x7x7xf32>, %c0: index) -> index {
  %0 = memref.dim %arg0, %c0 : memref<1x64x7x7xf32>
  return %0 : index
}